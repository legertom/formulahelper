...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="h-7 w-7 grid place-items-center border border-foreground/25 bg-background hover:bg-foreground/10 hover:border-foreground/50 text-foreground transition rounded-sm"
    >
      {mounted ? (
        isDark ? (
